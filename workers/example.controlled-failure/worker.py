"""Self-contained Docker worker for the example.controlled-failure goblin."""
...
KIND = "example.controlled-failure"


def main() -> None:
    """Publish a predictable failed result without crashing the container."""
    ...
    _heartbeat("failed", worker_id, run_id, job_id)
