...
| Generic Kubernetes validation | `goblin-king/v1alpha1` | The admin endpoint and explicit CLI runtime are additive; Docker remains the CLI default, and Kubernetes proof shares the typed runtime factory/settings used by scheduling. |
